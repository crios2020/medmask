<?php
	...
	if (isset($_GET['localidad'])){
		...
		$dbConn =  connect($db);
		$sql = $dbConn->prepare("SELECT s.id, u.id idUsuario, nombre,apellido,pais,provincia,localidad,email FROM usuarios u JOIN donantes s ON u.id=s.idUsuario where localidad=:localidad and provincia=:provincia and pais=:pais");
